...
# Тренировка сети
def Train(epochs, neural_network=train_neuralNetwork(inputnodes, hiddennodes, outputnodes, learningrate, 0, 0, t=False)):
...
def Identify(neural_network=neural_network(), image=(imageio.imread('img.jpg', as_gray=True))):
